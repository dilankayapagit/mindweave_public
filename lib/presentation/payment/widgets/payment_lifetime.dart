...
class PaymentLifeTime extends StatelessWidget {
  PaymentLifeTime(this.paymentModel, this.index, this.st);
  final String st;
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(
                () => GestureDetector(
                  onTap: () {
                    if ((userController.userCustomModel.value.isLife ??
                        false)) {
                    ...
                    controller.makePurchases(index,"mind_l");
                  },
                  child: Align(
